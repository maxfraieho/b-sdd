"""Generator script for NotebookLM documentation sources."""
import os
import glob
...
# Doc 3: Complete UI components and controls audit
doc3_content = """# B-SDD WORKBENCH UI ARCHITECTURE, COMPONENT CATALOG & INTERACTIVE CONTROLS AUDIT
...
with open(OUT_DIR / '03_UI_COMPONENTS_AND_CONTROLS_AUDIT.md', 'w', encoding='utf-8') as fp:
    fp.write(doc3_content)

print('Generated Doc 3, size:', len(doc3_content))
