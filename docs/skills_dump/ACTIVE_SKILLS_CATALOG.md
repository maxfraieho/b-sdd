...
**Дата генерації:** 2026-09-22 05:52:07Z  
...
- **Ключові файли:** `SKILL.md, references/adr-template.md, references/architecture-patterns.md, references/database-selection.md, references/nfr-checklist.md, references/system-design.md`
...
- **Ключові файли:** `LICENSE.txt, SKILL.md, references/output-patterns.md, references/workflows.md, scripts/init_skill.py, scripts/package_skill.py, scripts/quick_validate.py`
...
- **Кількість файлів коду/конфігів:** 2
- **Ключові файли:** `GLOSSARY.md, SKILL.md`
...
- **Кількість файлів коду/конфігів:** 3
- **Ключові файли:** `SKILL.md, anthropic-best-practices.md, persuasion-principles.md`
...
- **Кількість файлів коду/конфігів:** 2
- **Ключові файли:** `SKILL.md, agents/openai.yaml`
...
- **Кількість файлів коду/конфігів:** 3
- **Ключові файли:** `DEEPENING.md, DESIGN-IT-TWICE.md, SKILL.md`
...
- **Кількість файлів коду/конфігів:** 2
- **Ключові файли:** `HTML-REPORT.md, SKILL.md`
...
- **Кількість файлів коду/конфігів:** 7
- **Ключові файли:** `SKILL.md, references/common-issues.md, references/feedback-examples.md, references/receiving-feedback.md, references/report-template.md, references/review-checklist.md, references/spec-compliance-review.md`
...
- **Ключові файли:** `SKILL.md, references/api-docs-fastapi-django.md, references/api-docs-nestjs-express.md, references/coverage-reports.md, references/documentation-systems.md, references/interactive-api-docs.md, references/python-docstrings.md, references/typescript-jsdoc.md` (+ 1 more...)
...
- **Кількість файлів коду/конфігів:** 3
- **Ключові файли:** `README.md, SKILL.md, references/rule_reference.md`
...
- **Кількість файлів коду/конфігів:** 2
- **Ключові файли:** `SKILL.md, example.ts`
...
- **Кількість файлів коду/конфігів:** 6
- **Ключові файли:** `LICENSE.txt, SKILL.md, examples/console_logging.py, examples/element_discovery.py, examples/static_html_automation.py, scripts/with_server.py`
...
- **Кількість файлів коду/конфігів:** 6
- **Ключові файли:** `CREATION-LOG.md, SKILL.md, test-academic.md, test-pressure-1.md, test-pressure-2.md, test-pressure-3.md`
...
- **Кількість файлів коду/конфігів:** 2
- **Ключові файли:** `SKILL.md, find-polluter.sh`
...
- **Кількість файлів коду/конфігів:** 2
- **Ключові файли:** `SKILL.md, scripts/hitl-loop.template.sh`
...
- **Ключові файли:** `SKILL.md, animations.md, performance.md, surfaces.md, typography.md`
...
- **Кількість файлів коду/конфігів:** 73
- **Ключові файли:** `AGENTS.md, README.md, SKILL.md, rules/advanced-effect-event-deps.md, rules/advanced-event-handler-refs.md, rules/advanced-init-once.md, rules/advanced-use-latest.md, rules/async-api-routes.md` (+ 65 more...)
...
- **Ключові файли:** `AGENTS.md, README.md, SKILL.md, rules/architecture-avoid-boolean-props.md, rules/architecture-compound-components.md, rules/patterns-children-over-render-props.md, rules/patterns-explicit-variants.md, rules/react19-no-forwardref.md` (+ 3 more...)
...
- **Ключові файли:** `LICENSE.txt, SKILL.md, scripts/bundle-artifact.sh, scripts/init-artifact.sh`
...
- **Ключові файли:** `LICENSE.txt, SKILL.md, themes/arctic-frost.md, themes/botanical-garden.md, themes/desert-rose.md, themes/forest-canopy.md, themes/golden-hour.md, themes/midnight-galaxy.md` (+ 4 more...)
...
- **Ключові файли:** `LICENSE.txt, SKILL.md, reference/evaluation.md, reference/mcp_best_practices.md, reference/node_mcp_server.md, reference/python_mcp_server.md, scripts/connections.py, scripts/evaluation.py` (+ 2 more...)
...
- **Кількість файлів коду/конфігів:** 6
- **Ключові файли:** `SKILL.md, references/error-handling.md, references/openapi.md, references/pagination.md, references/rest-patterns.md, references/versioning.md`
...
- **Кількість файлів коду/конфігів:** 6
- **Ключові файли:** `SKILL.md, references/design-patterns.md, references/go-cli.md, references/node-cli.md, references/python-cli.md, references/ux-patterns.md`
...
- **Кількість файлів коду/конфігів:** 2
- **Ключові файли:** `README.md, SKILL.md`
