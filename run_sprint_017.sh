#!/usr/bin/env bash
# ==============================================================================
# B-SDD SPRINT 017 · CROSS-REPO MUTATION HARNESS & TRANSACTIONAL REFACTORING
# Standard: B-SDD Methodology v1.2 (ADR-001..017)
# ==============================================================================
set -euo pipefail
...
SPEC_DIR="specs/017-cross-repo-mutation-harness"
...
show_header() {
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║     ${BOLD}B-SDD SPRINT 017 · CROSS-REPO MUTATION HARNESS & REFACTORING${NC}${CYAN}         ║${NC}"
...
run_phase_6() {
    ...
    mkdir -p .context
    local handoff_file=".context/sprint_017_handoff.json"
...
run_phase_7() {
    ...
    echo -e "${GREEN}✓ Sprint 017 pipeline synthesized successfully.${NC}"
}
